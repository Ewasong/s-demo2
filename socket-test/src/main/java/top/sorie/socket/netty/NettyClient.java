...
import top.sorie.socket.RpcRequest;
import top.sorie.socket.RpcResponse;
import top.sorie.socket.kyro.KryoSerializer;
import top.sorie.socket.netty.NettyClientHandler;
import top.sorie.socket.netty.NettyKryoDecoder;
import top.sorie.socket.netty.NettyKryoEncoder;
...
public class NettyClient {
    ...
    public RpcResponse sendMessage(RpcRequest rpcRequest) {
        try {
            ...
            System.out.println("occur exception when connect server:" + e);
        }
        return null;
    }
